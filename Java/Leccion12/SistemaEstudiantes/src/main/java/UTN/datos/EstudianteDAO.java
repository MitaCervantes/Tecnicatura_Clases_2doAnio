...
public class EstudianteDAO {
    ...
    public static void main(String[] args) {
        ...
        var estudianteModificado = new Estudiante(1,"Juan Carlos", "Juarez", "54987654321", "jcjuarez@mail.com");
        ...
        //Agregar estudiante
        /*var nuevoEstudiante = new Estudiante("Carlos", "Lara", "54987654321", "carlosl@mail.com");
        var agregado = estudianteDao.agregarEstudiante(nuevoEstudiante);
        if(agregado){
            System.out.println("Estudiante agregado: "+nuevoEstudiante);
        }
        else{
            System.out.println("No se ha agregago estudiante: "+nuevoEstudiante);
        }*/
        ...
        if(encontrado){
            System.out.println("Estuidante encontrado: "+estudiante1);
        }
        else{
