...
public class SistemaEstudiantesApp {
    public static void main(String[] args) {
        ...
        //Se crea una instancia de la clase estudiante, esto lo hacemos fuera del ciclo
        var estudianteDao = new EstudianteDAO(); //Esta instancia dene hacerse una vez
        while(!salir){
            try{
    ...
    private static boolean ejecutarOpciones(Scanner consola, EstudianteDAO estudianteDAO){
        ...
        switch (opcion){
            case 1 -> {//Listar estudiantes
                ...
                //no muestra la información, sólo recupera la info y regresa una lista
            ...
            case 4 ->{//Modificar estudiante
                ...
                //Aquí lo primero es epecificar cual es el id del objeto a modificar
